...
{
    #region Sql Query
    private const string InsertBrewerySql = @"INSERT INTO Breweries (Name) VALUES (@Name) SELECT CAST(SCOPE_IDENTITY() AS int);";
    ...
    private const string GetBreweryIdByNameSql = @"SELECT Id FROM Breweries WHERE Name = @Name";
