...
namespace BeerWebshop.APIClientLibrary.ApiClient.DTO
{
    public class ProductApiClientStub : IProductAPIClient
    {
        ...
        private static List<ProductDTO> _beers = new List<ProductDTO>()
        {
            ...
            new ProductDTO { Id = 5, Name = "Wheat Wonder", Brewery = "Grain & Glory", Price = 4.99f, Description = "A light wheat Product perfect for summer.", Stock = 140, ABV = 4.2f, Type = "Wheat Product" },
        ...
        private int AddNewBeer(ProductDTO Product)
        {
